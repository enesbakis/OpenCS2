...
def parse_status(output: str) -> dict:
    ...
    Actual CS2 format (2024+):
        ...
        ---------players--------
          id     time ping loss      state   rate adr name
           2    01:47    9    0     active 786432 78.190.129.63:8333 'ExamplePlayer'
        #end
    ...
    for line in output.splitlines():
        ...
        # udp/ip   : 0.0.0.0:27015 (public REDACTED_IP:27015)
        ...
        # Format:    id  time/BOT/[NoChan]  ping  loss  state  rate  [adr]  'name'
            ...
            # e.g.: "   2    01:47    9    0     active 786432 78.190.129.63:8333 'ExamplePlayer'"
            m = re.match(
